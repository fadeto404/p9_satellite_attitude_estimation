...
%     mag_true_NED = [XYZ(1);XYZ(2);-XYZ(3)]; % Magnetic field vector in North East Up frame
    ...
    mag_true_i = mag_true_i/norm(mag_true_i);
    
    A = quat_att_mat(q_true(:,i));
    mag_true_b = A*mag_true_i;

    % Noisy measurements
    mag_meas1 = mag_true_b + [sig_mag*randn;sig_mag*randn;sig_mag*randn]; mag_meas1 = mag_meas1 / norm(mag_meas1);
    mag_meas2 = mag_true_b + [sig_mag*randn;sig_mag*randn;sig_mag*randn]; mag_meas2 = mag_meas2 / norm(mag_meas2);
    mag_meas3 = mag_true_b + [sig_mag*randn;sig_mag*randn;sig_mag*randn]; mag_meas3 = mag_meas3 / norm(mag_meas3);
...
meas = [mag_meas(1:30,:);sun_meas(1:30,:);st_meas(1:30,:);
        mag_meas(31:60,:);sun_meas(31:60,:);st_meas(31:60,:);
        mag_meas(61:90,:);sun_meas(61:90,:);st_meas(61:90,:);
        mag_meas(91:100,:);sun_meas(91:100,:);st_meas(91:100,:)];
