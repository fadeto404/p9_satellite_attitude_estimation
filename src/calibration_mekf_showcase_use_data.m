...
gyro_scaling_cov = eye(3)*((1e-6)*2000/3)^2; % Covariance of scaling (max/3)
gyro_misalignment_cov = gyro_scaling_cov; % Covariance (uncertainty) of misalignment (max/3)
...
poa=(0.1*pi/180/3600)^2*eye(3);
pog=(0.2*pi/180/3600)^2*eye(3);
P0 = blkdiag(poa, pog, gyro_scaling_cov, gyro_misalignment_cov, gyro_misalignment_cov);
...
load sim_data/ex6.1mod2/q.mat
load sim_data/ex6.1mod2/qm.mat
load sim_data/ex6.1mod2/w.mat
load sim_data/ex6.1mod2/wgm.mat
